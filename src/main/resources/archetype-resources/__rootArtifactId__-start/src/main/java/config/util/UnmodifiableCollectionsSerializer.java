...
public class UnmodifiableCollectionsSerializer extends Serializer<Object> {
     ...
     *
     * @see Collections${symbol_pound}unmodifiableCollection(Collection)
     * @see Collections${symbol_pound}unmodifiableList(List)
     * @see Collections${symbol_pound}unmodifiableSet(Set)
     * @see Collections${symbol_pound}unmodifiableSortedSet(SortedSet)
     * @see Collections${symbol_pound}unmodifiableMap(Map)
     * @see Collections${symbol_pound}unmodifiableSortedMap(SortedMap)
     */
